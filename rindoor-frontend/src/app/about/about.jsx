    ...
    <div className='w-full min-h-screen bg-gradient-to-r from-yellow-300 via-yellow-100 to-yellow-300 flex justify-evenly flex-col items-center'>
      <div className='w-full min-h-screen sm:w-3/4 sm:min-h-[300px]'>
        ...
        <div className='w-3/4 bg-azul h-96 sm:h-80 m-10  flex flex-col items-center justify-center rounded-xl'>
          ...
          <p className='text-white text-xl text-justify p-2'>Sign up now and get exclusive access to job opportunities in your area. Become part of our community of qualified professionals and access clients looking for your skills. Build your reputation and close profitable deals with Rin|Door. Open the door to professional success with us!</p>
          <div className='w-full flex justify-center'>
            <button className='w-[100px] h-[50px] border border-amarilloBG rounded text-yellow-300 '>Sign up</button>
          </div>
